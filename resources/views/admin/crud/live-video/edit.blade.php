                        ...
                        <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                          <li class="nav-item"> <a class="nav-link active" id="detail-product-tab" data-bs-toggle="pill" href="#detail-product" role="tab" aria-controls="detail-product" aria-selected="false">
                              ...
                              <div class="product-tab-content">
                                <h6>Edit Live Video Details</h6>
                                <p>Edit Live Video title & video</p>
                              </div></a></li>
                        ...
                        <div class="tab-content custom-input" id="add-product-pills-tabContent">
                          <div class="tab-pane fade show active" id="detail-product" role="tabpanel" aria-labelledby="detail-product-tab">
                            <div class="sidebar-body">
                              <form class="row g-3 common-form" method="POST" action="{{ route('admin.live-video.update', $liveVideo->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                
                                <div class="col-md-12">
                                  <label class="form-label" for="validationProductTitle">Live Video Title</label>
                                  <input class="form-control" name="title" id="validationProductTitle" type="text" placeholder="Title" value="{{ old('title', $liveVideo->title) }}">
                                </div>

                                <div class="col-md-6">
                                  <label class="form-label">Live Video</label>
                                  @if($liveVideo->video)
                                    <div class="mb-2">
                                      <video src="{{ asset('storage/' . $liveVideo->video) }}" controls style="max-width: 200px; height: auto; border-radius: 5px;">
                                ...
                                <div class="col-md-6">
                                  <label class="form-label">Live Video Views</label>
                                  <input class="form-control" name="views" type="text" placeholder="Views" value="{{ old('views', $liveVideo->views) }}">
                                </div>
