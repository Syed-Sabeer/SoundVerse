                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="detail-product-tab" data-bs-toggle="pill" href="#detail-product" role="tab" aria-controls="detail-product" aria-selected="false">
                                            ...
                                            <div class="product-tab-content">
                                                <h6>Add QnA Details</h6>
                                                <p>Add question, answer & keywords</p>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content custom-input" id="add-product-pills-tabContent">
                                    <div class="tab-pane fade show active" id="detail-product" role="tabpanel" aria-labelledby="detail-product-tab">
                                        <div class="sidebar-body">
                                            <form class="row g-3 common-form" method="POST" action="{{ route('admin.faq-question.store') }}">
                                                @csrf
                                                <div class="col-md-12">
                                                    <label class="form-label" for="question">Question <span class="text-danger">*</span></label>
                                                    <textarea class="form-control" name="question" id="question" rows="3" placeholder="Enter the question" required>{{ old('question') }}</textarea>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea id="answer" name="answer" class="form-control" rows="6" placeholder="Enter the answer" required>{{ old('answer') }}</textarea>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input class="form-control" name="keywords" id="keywords" type="text" placeholder="e.g., subscription, payment, account, billing" value="{{ old('keywords') }}" required>
