                        ...
                        <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                          <li class="nav-item"> <a class="nav-link active" id="detail-product-tab" data-bs-toggle="pill" href="#detail-product" role="tab" aria-controls="detail-product" aria-selected="false">
                              ...
                              <div class="product-tab-content">
                                <h6>Edit Subscription Details</h6>
                                <p>Edit subscription plan details</p>
                              </div></a></li>
                        ...
                        <div class="tab-content custom-input" id="add-product-pills-tabContent">
                          <div class="tab-pane fade show active" id="detail-product" role="tabpanel" aria-labelledby="detail-product-tab">
                            <div class="sidebar-body">
                              <form class="row g-3 common-form" method="POST" action="{{ route('admin.subscription.update', $subscription->id) }}">
                                @csrf
                                @method('PUT')
                                
                                <div class="col-md-6">
                                  <label class="form-label" for="title">Plan Title</label>
                                  <input class="form-control" name="title" id="title" type="text" placeholder="e.g., Premium Plan" value="{{ old('title', $subscription->title) }}" required>
                                </div>

                                <div class="col-md-6">
                                  <label class="form-label" for="price">Price</label>
                                  <input class="form-control" name="price" id="price" type="text" placeholder="e.g., 9.99" value="{{ old('price', $subscription->price) }}" required>
                                </div>

                                <div class="col-md-6">
                                  <label class="form-label" for="duration">Duration</label>
                                  <input class="form-control" name="duration" id="duration" type="text" placeholder="e.g., Monthly, Yearly" value="{{ old('duration', $subscription->duration) }}" required>
                                </div>

                                <div class="col-md-6">
                                  <label class="form-label" for="duration_months">Duration (Months)</label>
                                  <input class="form-control" name="duration_months" id="duration_months" type="number" placeholder="e.g., 1 for monthly, 12 for yearly" value="{{ old('duration_months', $subscription->duration_months) }}" min="1" required>
                                </div>
                                ...
                                <div class="col-md-6">
                                  <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_unlimitedstreaming" id="is_unlimitedstreaming" value="1" {{ old('is_unlimitedstreaming', $subscription->is_unlimitedstreaming) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                  <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_ads" id="is_ads" value="1" {{ old('is_ads', $subscription->is_ads) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                  <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_highquality" id="is_highquality" value="1" {{ old('is_highquality', $subscription->is_highquality) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                  <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_exclusivecontent" id="is_exclusivecontent" value="1" {{ old('is_exclusivecontent', $subscription->is_exclusivecontent) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                  <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_prioritysupport" id="is_prioritysupport" value="1" {{ old('is_prioritysupport', $subscription->is_prioritysupport) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                  <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_family" id="is_family" value="1" {{ old('is_family', $subscription->is_family) ? 'checked' : '' }} onchange="toggleFamilyFields()">
                                ...
                                <div class="col-md-6" id="family_limit_field" style="display: {{ $subscription->is_family ? 'block' : 'none' }};">
                                  <label class="form-label" for="family_limit">Family Member Limit</label>
                                  <input class="form-control" name="family_limit" id="family_limit" type="number" placeholder="e.g., 5" value="{{ old('family_limit', $subscription->family_limit) }}" min="1">
                                </div>

                                <div class="col-md-6">
                                  <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_parentalcontrol" id="is_parentalcontrol" value="1" {{ old('is_parentalcontrol', $subscription->is_parentalcontrol) ? 'checked' : '' }}>
