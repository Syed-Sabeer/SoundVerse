                    ...
                    <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12">
                        <div class="content_QR">
                            ...
                            <div class="store_button">
                                  <!-- App Store Button -->
                            <a href="{{ $appLink->app_store_link ?? '#' }}" class="store-btn app-store" {{ $appLink && $appLink->app_store_link ? 'target=_blank' : '' }}>
                            ...
                            <!-- Google Play Button -->
                            <a href="{{ $appLink->play_store_link ?? '#' }}" class="store-btn google-play" {{ $appLink && $appLink->play_store_link ? 'target=_blank' : '' }}>
                                <div class="store-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
