...
class MusicPlayer {
        ...
        this.tracks = [
            {
                ...
                artist: "Major Powell",
                duration: 352,
                cover: "/public/FrontendAssets/images/Ceo-singwithme.jpeg",
                src: "/public/FrontendAssets/songs/powelsong.aac"
            },
            {
                title: "Music Give Me",
                artist: "Major Powell",
                duration: 351,
                cover: "/public/FrontendAssets/images/ceo-singwithme-3.jpeg",
                src: "/public/FrontendAssets/songs/majorsong.aac"
            },
            // {
            //     title: "Don't Cry",
    ...
    togglePlay() {
        ...
        if (this.audio.paused) {
            ...
            if (this.pauseIcon) this.pauseIcon.style.display = 'inline';
            this.startProgress();
        } else {
            this.audio.pause();
            if (this.player) this.player.classList.remove('playing');
            if (this.playIcon) this.playIcon.style.display = 'inline';
